...
namespace Broccoli.Pipe {
	...
	public class BranchDescriptorCollection : ISerializationCallbackReceiver {
		...
		public class SproutStyle : ISerializationCallbackReceiver
		{
			...
			public AnimationCurve sproutTintDistribution = AnimationCurve.Linear (0f, 0f, 1f, 1f);
			...
			public SproutStyle Clone () {
				...
				clone.sproutTintDistribution = new AnimationCurve(this.sproutTintDistribution.keys);
