...
namespace Broccoli.Builder
{
	public class BillboardBuilder {
		...
		public Mesh GetBillboardMesh (bool clone = false) {
			#if UNITY_EDITOR
			if (clone) {
				Mesh clonedBillboardMesh = Object.Instantiate <Mesh> (billboardMesh);
				clonedBillboardMesh.name = "Billboard";
				return clonedBillboardMesh;
			}
			billboardMesh.name = "Billboard";
