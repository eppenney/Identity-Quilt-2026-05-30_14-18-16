	...
	public class TreeFactoryEditorWindow : EditorWindow 
	{
		...
		private void DrawPrefabOptions () {
			...
			if (GUILayout.Button (prefabButtonLabel, GUILayout.Width(30))) {
				string currentPath = System.IO.Directory.GetParent(Application.dataPath).ToString() + "/";
			...
			EditorGUILayout.EndHorizontal ();
			EditorGUILayout.HelpBox (treeFactory.treeFactoryPreferences.prefabSavePath + "/", MessageType.None);
