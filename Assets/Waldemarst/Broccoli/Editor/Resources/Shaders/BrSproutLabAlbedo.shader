Shader "Hidden/Broccoli/SproutLabAlbedo"
{
    Properties {
        ...
        _SproutTintDistribution ("Sprout Tint Distribution", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            HLSLPROGRAM
                ...
                sampler2D _SproutTintDistribution;
                ...
                fixed4 frag (v2f i) : Color
                {
                    ...
                    if (abs(i.uv5.w - 1.0) < 0.01) { // Geometry is sprout, uv5.w == 1.
                        ...
                        if (_SproutTintMode > 0) {
                            ...
                            // 1. Sample the curve texture using sproutPos as the U coordinate.
                            // The .r gets the value from the red channel.
                            float curveValue = tex2D(_SproutTintDistribution, float2(sproutPos, 0.5)).r;
                            // 2. Use the value from the curve to drive the lerp.
                            if (_InvertSproutTintMode == 0) {
                                _PosSproutTint = lerp(_MinSproutTint, _MaxSproutTint, curveValue);
                            } else {
                                _PosSproutTint = lerp(_MaxSproutTint, _MinSproutTint, curveValue);
                            }
