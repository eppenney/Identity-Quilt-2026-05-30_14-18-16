...
namespace Broccoli.TreeNodeEditor
{
    public class StructureGraphView : GraphView {
        ...
        private void _ViewTransformChanged (GraphView graphView) {
			...
			// If pan done.
			if ((Vector2)contentViewContainer.resolvedStyle.translate != contentOffset) {
				onPanDone?.Invoke (contentViewContainer.resolvedStyle.translate, contentOffset);
				SetContentViewOffset (contentViewContainer.resolvedStyle.translate);
			}
        }
