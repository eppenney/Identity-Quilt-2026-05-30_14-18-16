...
namespace Broccoli.TreeNodeEditor
{
	...
	public class BranchMeshGeneratorElementEditor : PipelineElementEditor {
		...
		SerializedProperty propSegmentAngleOffset;
		...
		private string MSG_SEGMENT_ANGLE_OFFSET = "Add rotation to the vertices on each segment of the mesh.";
		...
		protected override void OnEnableSpecific () {
			...
			propSegmentAngleOffset = GetSerializedProperty ("segmentAngleOffset");
		...
		protected override void OnInspectorGUISpecific () {
			...
			if (selectedToolbarOption == OPTION_LOD) {
				...
				// SEGMENT ANGLE OFFSET.
				EditorGUILayout.PropertyField (propSegmentAngleOffset);
				ShowHelpBox (MSG_SEGMENT_ANGLE_OFFSET);
				EditorGUILayout.Space ();
