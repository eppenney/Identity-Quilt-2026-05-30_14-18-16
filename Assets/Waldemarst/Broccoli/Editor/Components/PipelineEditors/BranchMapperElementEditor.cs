...
namespace Broccoli.TreeNodeEditor
{
	...
	public class BranchMapperElementEditor : PipelineElementEditor {
		...
		SerializedProperty propMappingXOffset;
		SerializedProperty propMappingYOffset;
		...
		private static int minTreeTilesValue = -7;
		private static int maxTreeTilesValue = 7;
		private static int minShrubTilesValue = -10;
		private static int maxShrubTilesValue = 10;
		private static int minTreeDisplacementValue = -7;
		private static int maxTreeDisplacementValue = 7;
		...
		private static GUIContent mappingXOffsetLabel = new GUIContent ("X Offset", "Offset applied to the U value on the UV mapping.");
		private static GUIContent mappingYOffsetLabel = new GUIContent ("Y Offset", "Offset applied to the V value on the UV mapping.");
		...
		private static string MSG_MAPPING_X_OFFSET = "Offset applied to the U component of the UV mapping.";
		private static string MSG_MAPPING_Y_OFFSET = "Offset applied to the V component of the UV mapping.";
		...
		protected override void OnEnableSpecific () {
			...
			propMappingXOffset = GetSerializedProperty ("mappingXOffset");
			propMappingYOffset = GetSerializedProperty ("mappingYOffset");
		...
		protected override void OnInspectorGUISpecific () {
			...
			textureXOffset = propMappingXOffset.floatValue;
			EditorGUILayout.Slider (propMappingXOffset, -1f, 1f, mappingXOffsetLabel); 
			ShowHelpBox (MSG_MAPPING_X_OFFSET);
			textureYOffset = propMappingYOffset.floatValue;
			EditorGUILayout.Slider (propMappingYOffset, -1f, 1f, mappingYOffsetLabel);
			ShowHelpBox (MSG_MAPPING_Y_OFFSET);
