...
namespace Broccoli.TreeNodeEditor
{
	...
	public class WindEffectElementEditor : PipelineElementEditor {
		...
		protected override void OnInspectorGUISpecific () {
			...
			FloatRangePropertyField (propMinSprout1Sway, propMaxSprout1Sway, 0f, 1.2f, labelSprout1Sway);
			ShowHelpBox (MSG_SPROUT1_SWAY);
			FloatRangePropertyField (propMinSprout2Sway, propMaxSprout2Sway, 0f, 1.2f, labelSprout2Sway);
