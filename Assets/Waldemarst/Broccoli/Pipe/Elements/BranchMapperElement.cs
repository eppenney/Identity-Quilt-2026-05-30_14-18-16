...
namespace Broccoli.Pipe {
	...
	public class BranchMapperElement : PipelineElement {
		...
		/// <summary>
		/// Offset applied to the U component in the UV mapping.
		/// </summary>
		public float mappingXOffset = 0f;
		/// <summary>
		/// Offset applied to the V component in the UV mapping.
		/// </summary>
		public float mappingYOffset = 0f;
		/// <summary>
		...
		override public PipelineElement Clone (bool isDuplicate = false) {
			...
			clone.mappingXOffset = mappingXOffset;
			clone.mappingYOffset = mappingYOffset;
