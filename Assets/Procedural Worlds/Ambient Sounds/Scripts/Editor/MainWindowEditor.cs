...
#region Tabs
        void ManagerSettingsPanel(bool inlineHelp)
        {
            ...
            if (Manager_UseAudioSourceGroup == null)
                Manager_UseAudioSourceGroup = new AnimBool(AmbienceManagerInstance.m_useAudioSource, Repaint);
            if (Manager_HideManagerObjectGroup == null)
                Manager_HideManagerObjectGroup = new AnimBool(AmbienceManagerInstance.m_hideManagerObject, Repaint);
