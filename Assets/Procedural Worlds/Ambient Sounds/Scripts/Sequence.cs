...
namespace AmbientSounds {
    ...
    public class Sequence : ScriptableObject, ISerializationCallbackReceiver {
        ...
        /// <summary> If greater than 0, the maximum number of loops his Sequence will play per activation </summary>
        ...
        /// <summary> Should this Sequence allow multiple instances to play from different Sources? (one per source) </summary>
        public bool m_allowMultipleInstances = false;
